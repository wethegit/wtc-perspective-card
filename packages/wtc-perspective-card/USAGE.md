...
Everything beyond the basics: configuration, accessibility, CSS custom
properties, events and extension points. For installation, the required
markup and a minimal working example, see the [README](./README.md); for the
full class/member reference, see the [API docs](./API.md).
...
| `data-duration`           | integer   | `800`      | Open animation duration in milliseconds. The close animation runs at ⅔ of this value.                                                               |
