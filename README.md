...
* [PerspectiveCard](#PerspectiveCard)
    * [new PerspectiveCard()](#new_PerspectiveCard_new)
...
| --- | --- | --- |
| element | <code>number</code> | The element that contains all of the card details |
...
| Param | Type | Description |
| --- | --- | --- |
| e | <code>number</code> | The pointer event object |
